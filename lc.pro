...
pro lc, ps=ps
	...
	readcol, 'data/BB.txt', t, F,err,F2,err2, format=('F,X,F,F,F,F')
;	readcol, 'S1.txt', t, F,err, format=('F,X,F,F')
	oploterror,t,F,err,psym=1,/nohat
	oploterror,t,F+F2,err,psym=1,/nohat
